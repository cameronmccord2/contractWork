...
_V_.extend({
  ...
  get: function(url, onSuccess, onError){
    ...
    var eleme = document.getElementById('angular-area');
    var scope = angular.element(eleme).scope();
    console.log(eleme)
    console.log("ttttttd")
    // angular.element($('#angularArea')).controller().$apply(function(){
    //   console.log('hereeee')
    //   $http.get(url).success(function(data){
    //     console.log('call success in videojs')
    //     onSuccess(data);
    //   }).error(function(data,config,headers){
    //     console.log("error with db call in videojs");
    //     console.log(data);
    //     console.log(config);
    //     console.log(headers);
    //   });
  ...
  console.log(scope, eleme)
  scope.$apply(function(){
    scope.getCaptionData(url).then(function(data){
      console.log(data);
      onSuccess(data);
    });
